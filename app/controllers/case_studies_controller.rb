class CaseStudiesController < ApplicationController
  ...
  def new
    @case_study = CaseStudy.new(project_id: params[:project_id])
  end
  ...
  private
    ...
    def case_study_params
      params.expect(case_study: [ :project_id, :context, :problem, :approach, :decisions, :implementation, :results, :metrics, :next_steps ])
    end
end
